<?php $__env->startSection('title', __('Add Salesman')); ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0"><?php echo e(__('Add Salesman')); ?></h1>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('salesmen.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        
                                                <div class="mb-3">
                            <div class="alert alert-info alert-sm">
                                <i class="bi bi-info-circle me-2"></i>
                                <?php echo e(__('Salesman code will be auto-generated when you save')); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           <?php echo e(in_array('food', old('classifications', [])) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           <?php echo e(in_array('non_food', old('classifications', [])) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> <?php echo e(__('Save Salesman')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u925629539/domains/mkalrawi.com/public_html/target/resources/views/salesmen/create.blade.php ENDPATH**/ ?>