                ...
                <form action="{{ route('users.update', $user) }}" method="POST">
                    ...
                    <div class="row" id="classification-section" style="display: none;">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label fw-medium">
                                    <i class="bi bi-tags me-1"></i>{{ __('Classifications') }}
                                </label>
                                @php
                                ...
                                <div class="form-check">
                                    <input class="form-check-input @error('classifications') is-invalid @enderror" 
                                           ...
                                           name="classifications[]" {{ in_array('food', $userClassifications) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input @error('classifications') is-invalid @enderror" 
                                           ...
                                           name="classifications[]" {{ in_array('non_food', $userClassifications) ? 'checked' : '' }}>
