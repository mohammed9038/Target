...
<?php $__env->startSection('title', __('Add User')); ?>

<?php $__env->startSection('content'); ?>
<div class="d-flex justify-content-between align-items-start mb-4">
    <div>
        <h1 class="h2 mb-1"><?php echo e(__('Add User')); ?></h1>
        <p class="text-muted mb-0"><?php echo e(__('Create a new user account')); ?></p>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="bi bi-person-plus me-2"></i><?php echo e(__('User Information')); ?>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="password" class="form-label fw-medium">
                                    <i class="bi bi-lock me-1"></i><?php echo e(__('Password')); ?> <span class="text-danger">*</span>
                                </label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <small class="text-muted"><?php echo e(__('Minimum 6 characters')); ?></small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="password_confirmation" class="form-label fw-medium">
                                    <i class="bi bi-lock-fill me-1"></i><?php echo e(__('Confirm Password')); ?> <span class="text-danger">*</span>
                                </label>
                                <div class="input-group">
                                    <input type="password" 
                                           class="form-control" 
                                    ...
                                    <?php $__currentLoopData = $regions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $region): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-check">
                                            <input class="form-check-input region-checkbox" type="checkbox" 
                                                   ...
                                                   <?php echo e(in_array($region->id, old('region_ids', [])) ? 'checked' : ''); ?>>
                                    ...
                                    <?php $__currentLoopData = $channels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $channel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="form-check">
                                            <input class="form-check-input channel-checkbox" type="checkbox" 
                                                   ...
                                                   <?php echo e(in_array($channel->id, old('channel_ids', [])) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="classification" name="classification">
                                    ...
                                    <option value="food" <?php echo e(old('classification') === 'food' ? 'selected' : ''); ?>>
                                        <?php echo e(__('Food')); ?>

                                    </option>
                                    <option value="non_food" <?php echo e(old('classification') === 'non_food' ? 'selected' : ''); ?>>
                                        <?php echo e(__('Non-Food')); ?>

                                    </option>
                                    <option value="both" <?php echo e(old('classification') === 'both' ? 'selected' : ''); ?>>
                                        <?php echo e(__('Both')); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle me-2"></i><?php echo e(__('Create User')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u925629539/domains/mkalrawi.com/public_html/target-system/resources/views/users/create.blade.php ENDPATH**/ ?>